...
client.on('message', (message) => {
  ...
  if(message.content == '유미야') {
    return message.reply('너랑 유미랑! 우리 함께 잘 해보자고!');
  }
  ...
  if(message.content == 'embed') {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setAuthor('유미', img, 'http://www.naver.com')
      .setThumbnail(img)
      .addBlankField()
